...
    yAxisID: metric.axis, 
    tension: 0.3, borderWidth: 2.5, pointRadius: 0, pointHoverRadius: 6,
  }));
...
    scales: {
      y: { 
        type: 'linear', position: 'left', suggestedMin: 0, suggestedMax: 100,
        display: activeMetrics.some(m => ['score', 'humi'].includes(m)),
        ticks: { color: '#94A3B8', font: { size: 10 } },
        grid: { color: 'rgba(0,0,0,0.04)' }
      },
      y1: {
        type: 'linear', position: 'right', suggestedMin: 400, suggestedMax: 1500,
        display: activeMetrics.includes('co2'),
        ticks: { color: '#F59E0B', font: { size: 10 } },
        grid: { drawOnChartArea: false }
      },
      y2: {
        type: 'linear', position: 'right', suggestedMin: 0, suggestedMax: 60,
...
                </div>
                <div style={{ fontSize: '24px', fontWeight: '800', color: bestFocusInsight?.time ? '#10B981' : '#94A3B8', fontFamily: "'DM Mono', monospace", marginBottom: '4px', letterSpacing: '-0.5px' }}>
...
                </div>
                <div style={{ fontSize: '24px', fontWeight: '800', color: co2WarningInsight?.time ? '#F59E0B' : '#94A3B8', fontFamily: "'DM Mono', monospace", marginBottom: '4px', letterSpacing: '-0.5px' }}>
...
                </div>
                <div style={{ fontSize: '24px', fontWeight: '800', color: goodRatioInsight ? '#6366F1' : '#94A3B8', fontFamily: "'DM Mono', monospace", marginBottom: '4px', letterSpacing: '-0.5px' }}>
...
                </div>
                <div style={{ fontSize: '24px', fontWeight: '800', color: avgScoreInsight ? '#4A5568' : '#94A3B8', fontFamily: "'DM Mono', monospace", marginBottom: '4px', letterSpacing: '-0.5px' }}>
