...
const HomeMobPage = () => {
  ...
  return (
    ...
    >
            ...
            return (
              <div
                ...
                style={{
                  ...
                  cursor: 'pointer',
                  background: isActive
                    ? 'linear-gradient(90deg, #00A8FF, #0077FF)'
                    : 'transparent',
                }}
              >
                ...
                <div>
                  ...
                  <div
                    style={{
                      fontSize: '12px',
                      color: isActive ? 'rgba(255,255,255,0.7)' : '#6B7A99',
                    }}
                  >
                    {menu.sub}
                  </div>
      ...
      <h2 style={{ fontSize: '17px', fontWeight: '700', padding: '0 20px', marginBottom: '16px', marginTop: '24px', color: '#1E293B' }}>
        주요 센서
      </h2>
